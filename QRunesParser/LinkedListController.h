...
class subQList
{
  ...
  public:
    ...
    ***************************************************/
    ...
    subQList(const subQList &b);
    subQList &operator=(const subQList &b);
};
...
class QList
{
  ...
  private:
    ...
    ***************************************************/
    ...
    stack<vector<size_t>> controlStack;
  ...
  public:
    ...
    * return
    ***************************************************/
    bool API gateInsert(int, int, int);
    ...
    * return
    ***************************************************/
    bool API gateInsert(int, int, int, int);
    ...
    ***************************************************/
    ...
    bool ControlInsert1(vector<size_t> controll_list);
    /*************************************************
    * class     QList
    * name      ControlDelete
    * visible   yes
    ...
    ***************************************************/
    ...
    bool ControlDelete1(vector<size_t> controll_list);
    /*************************************************
    * class     QList
    * name      TraverseAll
    * visible   yes
    ...
    ***************************************************/
    API void TraverseAll(QNode *sub, QuantumGateParam *pQuantumProParam, QuantumGates *pQGate);

    void TraverseAll_T(GateType_t *gateType, subQList *sub, int iRank);
};
